<template>
  <button-with-confirmation
      class="btn btn-danger btn-sm pterois-delete-area-button"
  ...
  <form method="post" ref="deletionForm" class="d-inline float-end pterois-alert-delete-form" :action="props.formAction">
