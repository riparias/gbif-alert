...
- [Python](https://www.python.org/) 3.8+, [(Geo)Django](https://www.djangoproject.com/) 4.0 [PostgreSQL](https://www.postgresql.org/), [PostGIS](https://postgis.net/) 3.1+, [Redis](https://redis.io/),  [TypeScript](https://www.typescriptlang.org/) and [Vue.js v3](https://vuejs.org/)
